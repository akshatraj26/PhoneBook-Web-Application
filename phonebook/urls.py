...
from .views import index, contact_list ,new_contact, contact_detail, delete_contact, update_contact, edit_profile, ContactView, ContactUs, about_me, profile
...
urlpatterns = [
    ...
    path('phonebook/contact_me/', ContactUs.as_view(), name='contact'),
